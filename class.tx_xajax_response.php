...
// The tx_xajax_response class is used to created responses to be sent back to your
...
class tx_xajax_response {
	...
	// processor on your page. Since xajax 0.2, you can also return an tx_xajax_response
	...
	{
		if (is_a($mXML, "tx_xajax_response")) {
			$mXML = $mXML->getXML();
		}
		$sNewXML = "";
