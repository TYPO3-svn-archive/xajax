...
class tx_xajax_response
{
	 ...
	 * 
	 */
	function tx_xajaxmp_response($sEncoding=XAJAX_DEFAULT_CHAR_ENCODING, $bOutputEntities=false)
	{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/xajax/lib/class.tx_xajax_response.php'])	{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/xajax/lib/class.tx_xajax_response.php']);
}
